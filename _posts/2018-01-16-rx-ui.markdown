...
> <a href="https://github.com/rongi/rx-presenter-example/blob/master/app/src/main/java/com/github/rongi/rxpresenter/example/app/main/MainViewModel.kt" target="\_blank">Here</a> is an example of how your `present()` function may look like in the end
