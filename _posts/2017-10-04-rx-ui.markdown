...
For an activity, `onCreate()` function serves the same role as `main()` function for an application: it'a a main entry point. Having this in mind, you may notice that our application looks like this:
