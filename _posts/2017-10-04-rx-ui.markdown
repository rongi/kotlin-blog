...
But how to render view states is a trivial matter. The heart of our program is the `present()` function. It owns all the complexity and all non-trivial presentation logic. Let's see how it's implemented. And let's take this activity as an example:

[Image]

It have an "update" button. When we hit it, a list of articles is downloaded and displayed.

Pretty simple activity. This is how implementation will look like:
