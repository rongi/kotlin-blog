...
It displays a list of articles. This list is updated each time "update" button is clicked.
...
You can notice that it looks very much like traditional Presenter. Just class fields are function parameters now.
