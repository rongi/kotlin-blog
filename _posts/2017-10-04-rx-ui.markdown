...
I'd started my journey with a traditional `class Presenter`, and just tried to implement the logic inside with Rx, step by step. It quickly became obvious though, that class is no longer needed, it became clear that my presenter is trying to take this form:
...
It's just a collection of observables. To render, subscribe to each of them and map emitted values to view properties:
