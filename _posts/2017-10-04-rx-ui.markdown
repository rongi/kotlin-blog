...
Let's take another look on how our `Activity` looks like:
...
`onCreate()` function is an entry point to the application, just like a `main()` function is. Having this in mind, you may notice that our application looks like this:
